...
<div class="owl-carousel owl-theme slider-parent" style="">
    <div class="item" style="">
        <div class="col-md-12 slider-container" style="background-color: rgba(0,0,0,0.5)">
            ...
            <div class="col-md-8 topslider-image right" style="background-image: url('<?php echo base_url('assets/img/slider/w1.jpg'); ?>');width:100%">
    ...
    <div class="item" style="">
        <div class="col-md-12 slider-container" style="background-color: rgba(0,0,0,0.5)">         
            <div class="col-md-8 topslider-image right" style="background-image: url('<?php echo base_url('assets/img/slider/w2.jpg'); ?>');width:100%">
            </div>
        </div>
    </div>  
    <div class="item" style="">
        <div class="col-md-12 slider-container" style="background-color: rgba(0,0,0,0.5)">         
            <div class="col-md-8 topslider-image right" style="background-image: url('<?php echo base_url('assets/img/slider/w3.jpg'); ?>');width:100%">
            </div>
        </div>
    </div>  
    <div class="item" style="">
        <div class="col-md-12 slider-container" style="background-color: rgba(0,0,0,0.5)">         
            <div class="col-md-8 topslider-image right" style="background-image: url('<?php echo base_url('assets/img/slider/w4.jpg'); ?>');width:100%">
            </div>
        </div>
    </div>  
    <div class="item" style="">
        <div class="col-md-12 slider-container" style="background-color: rgba(0,0,0,0.5)">         
            <div class="col-md-8 topslider-image right" style="background-image: url('<?php echo base_url('assets/img/slider/w5.jpg'); ?>');width:100%">
            </div>
        </div>
    </div>  
    <div class="item" style="">
        <div class="col-md-12 slider-container" style="background-color: rgba(0,0,0,0.5)">         
            <div class="col-md-8 topslider-image right" style="background-image: url('<?php echo base_url('assets/img/slider/w6.jpg'); ?>');width:100%">
            </div>
        </div>
    </div>    
</div>
