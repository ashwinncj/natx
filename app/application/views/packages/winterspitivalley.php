...
<div id="page-parent" style="background-image: url('<?php echo base_url('assets/img/packageheader/header_winter_spiti2.jpg'); ?>'); background-position:center;background-size:cover;"> 
    <!--<div id="page-parent" style="position:relative">-->
    <?php //$this->load->view('topslider'); ?>
    <div id="page-layout" style="padding: 20px">
        <div style="background-image: url('<?php echo base_url('assets/img/packageheader/header_winter_spiti.jpg'); ?>'); height: 300px;background-position:center;background-size:cover;"> 
        </div>
        <h1>
            <!--        //Put heading here-->
