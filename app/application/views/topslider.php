...
<div class="owl-carousel owl-theme">
    <div class="item" style="">
        <div class="col-md-12 slider-container" style="background-color: rgba(0,0,0,0.5)">
            <div class="col-md-4 left" style="text-align: right;padding: 10px;">
            ...
            <div class="col-md-8 topslider-image right" style="background-image: url('<?php echo base_url('assets/img/TigerNATX1.jpg'); ?>');">
